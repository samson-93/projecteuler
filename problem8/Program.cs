...
digitList = digitList.Replace("\r", "").Replace("\n", "");
...
void GetLargestProduct(int adjacentDigitCount, out ulong largestProduct, out string largestDigitSelection)
{
    largestProduct = 0;
    largestDigitSelection = "";
    
    int startIndex = 0;
    while ((startIndex + adjacentDigitCount) <= digitList.Length)
    {
        var digitSelection = digitList.Substring(startIndex, adjacentDigitCount);
